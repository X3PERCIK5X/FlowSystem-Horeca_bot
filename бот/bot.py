...
logger = logging.getLogger("horeca_bot")
...
NOTIFY_CHAT_IDS: list[int] = parse_chat_ids(ENV_NOTIFY_CHAT_IDS) if ENV_NOTIFY_CHAT_IDS else []
...
def main_keyboard() -> InlineKeyboardMarkup:
    ...
    if WEBAPP_URL:
        rows.append([InlineKeyboardButton("Меню / Бронь", web_app=WebAppInfo(url=WEBAPP_URL))])
